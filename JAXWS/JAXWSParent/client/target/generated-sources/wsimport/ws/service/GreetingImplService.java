 ...
 * 
 */
@WebServiceClient(name = "GreetingImplService", targetNamespace = "http://service.ws/", wsdlLocation = "http://localhost:8080/WS/Greeting")
    ...
    extends Service
{
    ...
    private final static QName GREETINGIMPLSERVICE_QNAME = new QName("http://service.ws/", "GreetingImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/WS/Greeting");
    ...
    public Greeting getGreetingImplPort() {
        return super.getPort(new QName("http://service.ws/", "GreetingImplPort"), Greeting.class);
    }
    ...
    public Greeting getGreetingImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.ws/", "GreetingImplPort"), Greeting.class, features);
    }
